...
@Component
@Slf4j
public class DiscountCalSettleRpcService implements ICalSettleRpcService{

    @Autowired
    private DiscountCacheFactory discountCacheFactory;
    ...
    public MatchFeeResponse calSettle(CalFeeRequest request) {
        ...
        // 报价匹配
        List<Settle> candidates = discountCacheFactory.getAllSettleConfigOfType();
